	...
	<div class="row">
		...
		<div style="background-color:#fff" class="col-md-7">
			...
			<form method="post" action="<?php echo site_url('process/proc_public/edit_profile')?>" class="form-horizontal" role="form">
				...
				<div class="form-group">
					<label for="moto" class="col-lg-2 control-label">*Password lama</label>
					<div class="col-md-10">
					<input class="form-control" type="password" value="<?php echo $view['password'];?>" name="old_password"/>
					</div>
				</div>
				<div class="form-group">
					<label for="moto" class="col-lg-2 control-label">*Password baru</label>
					<div class="col-md-10">
					<input class="form-control" type="password" value="" name="new_password"/>
					</div>
				</div>
				
				<!-- <input type="password" value="<?php echo $view['password']?>" name="new_password"/>
