...
<ul class="nav nav-tabs" id="myTab">
	...
	<li id="komentar"><a href="<?php echo site_url('dashboard/manage?id='.$_GET['id'].'&act=komentar');?>">Komentar <span style="margin-left:4px" class="badge pull-right"><?php echo $count_komentar;?></span></a></li>
